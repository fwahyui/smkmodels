...
<header class="head">
	<div class="main-bar">
		<h3><i class="icon-home"></i> Tambah DU</h3>
	</div>
</header>
<?php 
if ($act==0)
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpandu.php?act=0&th=<?php echo $TahunAktif?>" method="post">
				<br>
                ...
                <div class="control-group">
					<label for="text1" class="control-label">Rincian</label>
					<div class="controls with-tooltip">
						<input type="text" id="text1" class="span6 input-tooltip" name="Rician"
						data-original-title="Masukan Jumlah Siswa - Contoh: 30" data-placement="bottom"/>
					</div>
				</div>			
...
else
{
	include "koneksi.php";
	$id = $_GET['id'];
	$sql = "SELECT a.kodedu,b.NAMA_JUR,a.Nama,a.TahunAjaran,a.Nominal,a.Rician,a.Kode_jur
                                        FROM du a, jurusan b
                                        WHERE a.Kode_jur = b.KODE_JUR and a.kodedu=$id";
	$rw=mysql_query($sql);
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpandu.php?act=1&kelas=<?php echo $id; ?>&th=<?php echo $TahunAktif ?>" method="post">
				<br>
				<div class="control-group">
					<label class="control-label">Jurusan</label>
					<div class="controls">
