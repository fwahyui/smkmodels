...
<header class="head">
	<div class="main-bar">
		<h3><i class="icon-home"></i> Tambah Guru</h3>
	</div>
</header>
<?php 
if ($act==0)
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpanguru.php?act=0" method="post">
				<br>
				<div class="control-group">
					<label for="text1" class="control-label">NIP</label>
					<div class="controls with-tooltip">
						<input type="text" id="text1" class="span6 input-tooltip" name="NIP"
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpanguru.php?act=1" method="post">
				<br>
				<div class="control-group">
					<label for="text1" class="control-label">NIP</label>
					<div class="controls with-tooltip">
