...
CREATE TABLE `buku` (
  ...
  `PKT_BUKU` varchar(10) DEFAULT NULL,
  `SEMESTER_BUKU` varchar(10) DEFAULT NULL,
  `THN_BUKU` int(11) DEFAULT NULL,
...
insert  into `prakerin`(`kodeprakerin`,`Kode_jur`,`TahunAjaran`,`Biaya`,`Keterangan`) values (1,1,'2016/2017',450,'bulan january');
