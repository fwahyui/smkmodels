...
<header class="head">
	<div class="main-bar">
		<h3><i class="icon-home"></i> Tambah UTS</h3>
	</div>
</header>
<?php 
if ($act==0)
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpanuts.php?act=0&th=<?php echo $TahunAktif?>" method="post">
				<br>
				...
				<div class="control-group">
					...
					<div class="controls with-tooltip">
						<input type="text" id="text1" class="span6 input-tooltip" name="NAMAUTS"
...
else
{
	include "koneksi.php";
	$id = $_GET['id'];
	$sql = "SELECT a.KODEUTS,b.NAMA_JUR,a.Grade,a.NAMAUTS,a.TahunAjaran,a.Nominal,a.Kode_jur
                                        FROM uts a, jurusan b
                                        WHERE a.Kode_jur = b.KODE_JUR and a.KODEUTS=$id";
	$rw=mysql_query($sql);
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpanuts.php?act=1&kelas=<?php echo $id; ?>&th=<?php echo $TahunAktif ?>" method="post">
				<br>
				<div class="control-group">
					<label class="control-label">Jurusan</label>
					<div class="controls">
