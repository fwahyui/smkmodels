...
<header class="head">
	<div class="main-bar">
		<h3><i class="icon-home"></i> Tambah Seragam</h3>
	</div>
</header>
<?php 
if ($act==0)
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpanseragam.php?act=0&th=<?php echo $TahunAktif?>" method="post">
				<br>
					...
					<div class="controls with-tooltip">
						<input type="text" id="text1" class="span6 input-tooltip" name="NamaSeragam"
              ...
              <div class="control-group">
					...
					<div class="controls">
						...
						name="JenisKelamin">
                            ...
                            <option value="<?php echo $rs[4];?>"></option>
						</select>
					</div>
				</div>
				<div class="control-group">
...
else
{
	...
	$sql = "SELECT a.KodeSeragam,b.NAMA_JUR,a.NamaSeragam,a.TahunAjaran,a.JenisKelamin,a.Harga,a.KodeSeragam,b.KODE_JUR
                                        FROM seragam a, jurusan b
                                        WHERE a.Kode_Jur = b.KODE_JUR and KodeSeragam=$KodeSeragam ";
...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			...
			<form class="form-horizontal" action="simpanseragam.php?act=1&kelas=<?php echo $KodeSeragam; ?>&th=<?php echo $TahunAktif ?>" method="post">
				<br>
				<div class="control-group">
